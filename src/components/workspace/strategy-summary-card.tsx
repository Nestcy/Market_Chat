    ...
    <section className="rounded-xl border border-border/70 bg-card px-5 py-5 shadow-[0_18px_40px_-32px_rgba(0,0,0,0.9)]">
      ...
      <div className="mt-5 flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className="rounded-lg border border-border bg-surface/50 px-3.5 py-2 text-xs text-muted-foreground transition-colors hover:border-accent-warm/50 hover:text-foreground disabled:opacity-50"
        >
          Request Changes
        </button>
      </div>
      ...
      {open ? (
        <div className="mt-3">
          <textarea
            ...
            className="w-full resize-none rounded-lg border border-border bg-surface/60 px-3 py-2 text-xs text-foreground outline-none focus:border-accent-warm/60 disabled:opacity-50"
          />
          <button
            type="button"
